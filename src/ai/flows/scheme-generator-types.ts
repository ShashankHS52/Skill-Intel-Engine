...
export const SuggestedSchemeSchema = z.object({
  ...
  objectives: z.array(z.string()).describe('A list of key objectives for the new scheme.'),
...
export type SuggestedScheme = z.infer<typeof SuggestedSchemeSchema>;
