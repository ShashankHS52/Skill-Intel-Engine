...
export type ScenarioTestingInput = z.infer<typeof ScenarioTestingInputSchema>;
...
export type ScenarioTestingOutput = z.infer<typeof ScenarioTestingOutputSchema>;


export async function simulateEconomicImpact(input: ScenarioTestingInput): Promise<ScenarioTestingOutput> {
